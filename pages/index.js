...
function Categories(){
  ...
  return (
    ...
    <Row gutter={[2,32]} style={{justifyContent:'center' , marginBottom:'4em'}}>
      <Col className="gutter-row" lg={{span:5}} md={{span:10}} sm={{span:20}}  >
      <Image
        width={200}
        preview={false}
...
<Col span={13} className="registrate">
  ...
  <Row className="centered">
    ...
    <BasicModal show={showModal} setShow={setShowModal} title={titleModal} width={500}>
          <Auth onCloseModal={onCloseModal} setTitleModal={setTitleModal} showRegister={showRegister} setShowRegister={setShowRegister}/>
    </BasicModal>
