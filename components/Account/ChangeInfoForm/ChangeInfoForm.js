...
export default function ChangeInfoForm(props) {
    ...
    return (
        <div className='change-info-form'>
            ...
            <Form labelCol={{span:7, offset:2}} wrapperCol={{span:10,offset:0}}  className='login-form'  onFinish={onFinish}/* validateMessages={validateMessages}*/>
            <Form.Item
            label=" Nuevo Nombre"
            name='name'
            rules={[
            ...
            <Form.Item name="password_confirmation" label='Confirmar Nueva Contraseña' 
