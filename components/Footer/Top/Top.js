    ...
    return(
        <Layout>
            <Row>
                ...
                <Col lg={{span:10}} md={{span:10 }} sm={{span:11, offset:4}} xs={{span:11, offset:4}} onClick={showModal}>   
                <h3>Términos y condiciones</h3>
                </Col>
                <Modal title="Términos y condiciones" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel} footer='' bodyStyle={{height:'30em' , overflow:'scroll'}} width={1000}>
            ...
            <Row>
                ...
                <Col lg={{span:10}} md={{span:10, offset:0}} sm={{span:10, offset:3}} xs={{span:11, offset:4}} onClick={showModal2}>
                <h3>Politicas de uso</h3>
                </Col>
                <Modal title="Politicas de uso" visible={isModalVisible2} onOk={handleOk2} onCancel={handleCancel2} footer=''>
                    <p>Somee contents...</p>
                    <p>Somee contents...</p>
                    <p>Somee contents...</p>
                </Modal>
