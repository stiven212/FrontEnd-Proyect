           ...
           <div className='order'>
                <div className='order__info'>
                    ...
                    {detail && (
                        ...
                        <a>
                            <Image src={detail.product[0].image1} alt={detail.product[0].name}  preview={false}/>
                        </a>
                        </Link>
                            <div>
                        ...
                        <div className='order__other'>
                            <p className='order__other-date'>
                                {moment(detail.created_at).format("L")} - {moment(detail.created_at).format("LT")}
                            </p>
                            <EyeOutlined onClick={() => setShowModal(true)} />                        
                            
                            </div>
                            <AddressModal showModal={showModal} setShowModal={setShowModal} addressShipping={detail.address} detail={detail.details}/>
...
function AddressModal(props) {
    const { setShowModal, showModal, addressShipping, detail} = props;
    return (
