    ...
    return (
        <div className='list-products'>
            <Row>
                ...
                <Col lg={{span:5, offset:1}} md={{span:6, offset:2}} sm={{span:10, offset:2}} xs={{span:24}}>
         ...
         <Link href={`/categories/products/${product.id}`}>
             ...
             <a>
                <div className='list-products__product-image'>
                    ...
                    <Image src={"http://localhost:8000/storage/products/APOu2peZNTuU863VPmES2OwRto1uWgPdA17h6OUh.png"} preview={false}/>
