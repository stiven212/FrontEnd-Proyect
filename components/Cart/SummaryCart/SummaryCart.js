...
export default function SummaryCart(props) {
    ...
    {map(products, (product) => (
        data.push({
            ...
            producto : <div className='summary-cart__product'>
            <DeleteOutlined onClick={() => removeProduct(product.id)} style={{fontSize:'20px' ,color:'red'}}/> 
            {/* <Image src={product.image1} alt={product.name}/> */}
            <Image src={"http://localhost:8000/storage/products/APOu2peZNTuU863VPmES2OwRto1uWgPdA17h6OUh.png"} preview={false} width='20%'  alt={product.name}/>
            {product.name}
            </div >,
            categoria: <>
    ...
    data.push({
        ...
        precio: <div className='total-price'>
